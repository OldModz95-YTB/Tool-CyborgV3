...
namespace Tutorial_For_YouTube
{
    ...
    internal class RPC
    {
        ...
        {
            return PS3.Extension.ReadByte(0x17810E3 + 0x5808 * (uint)Client);
        }
        ...
        {
            PS3.Extension.WriteByte(0x467507, (Byte)KeyboardType);
            ...
            while (PS3.Extension.ReadInt32(0xD82140) != 0)
                continue;
            return PS3.Extension.ReadString(0x03090E22);
        }
        public static int precacheShader(string Shader)
        {
            PS3.Extension.WriteInt32(0x1608100 + 0x40, 1);
